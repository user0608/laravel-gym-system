...
<body class="auth-page height-auto bg-grey-600">
        ...
        <div class="panel overflow-hidden">
            ...
            <form id="loginform" method="post" action="{{ url('/auth/login') }}">
                ...
                <div class="box-body padding-md">
                    ...
                    <button type="submit" class="btn btn-dark bg-light-green-500 padding-10 btn-block color-white"><i
                            class="ion-log-in"></i> Sign in</button>
                </div>
            </form>
            <div class="panel-footer padding-md no-margin no-border bg-grey-900 text-center color-white">&copy; 2016
                Gymie by LUBUS</div>
        </div>
    </div>
    ...
    <!-- bootstrap validator -->
    <script src="{{ URL::asset('assets/plugins/bootstrapValidator/bootstrapValidator.min.js') }}" type="text/javascript">
    </script>
